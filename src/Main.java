public class Main {
    public static void main(String[] args) {tasks1();tasks2();tasks3();tasks4();tasks5();tasks6();tasks7();tasks8();
 ...
 //           System.out.println(birthRate+" рождаймость "+mortality+" смертность в год");
        }
